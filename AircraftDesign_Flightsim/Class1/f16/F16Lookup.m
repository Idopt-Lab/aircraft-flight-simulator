...
CL = interp2(elevator_range, alpha_range, CLDh_table, 0, alpha, 'linear', 0);
CD = interp2(elevator_range, alpha_range, CDDh_table, 0, alpha, 'linear', 0);
Cm = interp2(elevator_range, alpha_range, CmDh_table, 0, alpha, 'linear', 0);

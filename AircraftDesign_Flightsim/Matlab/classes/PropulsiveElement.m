    ...
    methods
        ...
        function [F, M, fuel_flow] = get_force_moment(obj, M_inf, alt, V, rho)
            ...
            elseif strcmpi(et, "propeller")
                [thrust, fuel_flow] = obj.calculate_propeller_thrust(V, rho, alt);
        ...
        % ====== FIXED: now includes altitude ======
        function [thrust, fuel_flow] = calculate_propeller_thrust(obj, V, rho, alt)

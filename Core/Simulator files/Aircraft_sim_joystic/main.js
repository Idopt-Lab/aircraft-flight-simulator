Cesium.Ion.defaultAccessToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiJhMzBlNDM3OS1hZGRiLTRmYmYtOGQxZi1hMmRhYWY1ZTNkMzAiLCJpZCI6MzM1MjcwLCJpYXQiOjE3NTYxNTIxMTd9.ZvygYOTfjmaokfMItyZHV7mCXvEgVCVSeRO-V98kPrQ";
...
const aircraftEntity = viewer.entities.add({
  name: "Buffalonius",
  model: {
    url: "Untitled.glb",  // or your own .gltf/.glb model
    scale: 0.5
  }
});
